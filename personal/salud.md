...
## TDAH — diagnóstico y tratamiento

### 24/07/2026 — Visita psicólogo/médico TDAH
- Pidió diagnóstico formal por escrito, sin querer medicarse en principio.
- El médico solo ofrece la vía de medicación como solución ("dice que pruebe") — José Luis reacio pero acepta probar.

### 25/07/2026 — Pauta de medicación recibida (foto de receta, Área Salut Eivissa i Formentera)
Lectura de la hoja manuscrita — confirmar si algo no cuadra:

- **Concerta 27mg (metilfenidato, liberación prolongada)** — toma en el desayuno. Efecto dura 6-8h.
  - Alternativa mencionada por el médico: Rubifén 10mg (metilfenidato de liberación inmediata, dura 3-4h, 1/2 comprimido) — parece explicación comparativa, no está claro si es lo que toma o solo referencia.
- **Zolpidem 10mg** — para dormir, antes de acostarse, 1 comprimido (insomnio).
- **Brintellix (vortioxetina) en gotas** — para ansiedad constante. Pauta: 5 gotas (7-14 días), luego continuar con 10 gotas. Nombre confirmado por José Luis 25/07/2026.
...
- Empieza en 27mg unos 5-7 días, evalúa. Si tolera bien y falta efecto → sube al siguiente escalón, dejando días entre subidas.
